...
\begin{abstract}
    ``AWStats is short for Advanced Web Statistics. AWStats is powerful
    ...
    server logs.  Data is graphically presented in easy to read web
    pages.''\footnote{What is AWStats, \href{https://awstats.sourceforge.io/\#WHAT}{https://awstats.sourceforge.io/\#WHAT}}
